...
/**
 * Clase que representa el modelo 6.2 para especialistas en el proceso de escrutinio.
...
public class Modelo_6_2_Especialistas extends Preaviso {
    ...
    public String toString() {
        return STR."Modelo_6_2_Especialistas de \{getNombreEmpresa()} Cumplimentado";
    }
}
