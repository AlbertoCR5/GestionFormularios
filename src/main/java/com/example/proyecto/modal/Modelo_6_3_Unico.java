 ...
 * @version 1.0
 */
public class Modelo_6_3_Unico extends Preaviso {
     ...
     */
    public Modelo_6_3_Unico(String nombreEmpresa, String CIF) throws CumplimentarPDFException {
     ...
     */
    public Modelo_6_3_Unico(String nombreEmpresa, String CIF, List<Candidatura_Comite> candidaturasEspecialistas, String[] incidencias) throws CumplimentarPDFException {
        super(nombreEmpresa, CIF);
