 ...
 * @version 1.0
 */
public class Modelo_6_2_Unico extends Preaviso {
     ...
     */
    public Modelo_6_2_Unico(String nombreEmpresa) {
        super(nombreEmpresa);
    }
     ...
     */
    public Modelo_6_2_Unico(String nombreEmpresa, String sindicato, List<Candidato_Comite> candidatosEspecialistas) {
        super(nombreEmpresa);
